    ...
    function OneDView() {
        ...
        */
        ...
        this.showExtraData = function (index) {
            ...
            this.$el.find(".one-D-summary-description").html(this.rowElements[index].uniqueDescription);
            ...
            if (this.rowElements[index].type === "video-live") {
                if (this.rowElements[index].isLiveNow)
                {
                    ...
                    this.$el.find(".one-D-summary-description").html('<div class="one-D-live-icon" ></div>' +
                        '<div>'+ this.rowElements[index].uniqueDescription +'</div>');
                ...
                if (this.rowElements[index].hasOwnProperty("videoId")) {
                    this.$el.find(".one-D-summary-pubdate").html(this.rowElements[index].duration.toLocaleString());
                } else if(this.rowElements[index].hasOwnProperty("seriesId")) {
                    this.$el.find(".one-D-summary-pubdate").html(this.rowElements[index].episodesCount.toLocaleString() + " Episodes");
                }
                this.$el.find(".one-D-summary-description").css("margin-top", "");
            }
        };
