...
(function(exports) {
    ...
    function Utils(settings) {
        ...
        this.multipleAjax = function(requests, dataLoadedCallback) {
            $.when.apply($, requests).done(function() { // Make all the ajax calls
                dataLoadedCallback(); // Tell model-json.js that data is loaded
            });
        }
